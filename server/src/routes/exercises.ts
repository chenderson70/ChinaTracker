          ...
          for (const sourcePersonnelEntry of sourcePersonnelEntries) {
            await tx.personnelEntry.create({
              data: {
                ...
                utcCode: sourcePersonnelEntry.utcCode == null ? null : String(sourcePersonnelEntry.utcCode || '').trim().toUpperCase(),
                utcTitle: sourcePersonnelEntry.utcTitle == null ? null : String(sourcePersonnelEntry.utcTitle || '').trim(),
